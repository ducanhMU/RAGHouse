...
-- ========================================
-- 1. DIMENSION: Companies (FIXED)
-- ========================================
CREATE TABLE IF NOT EXISTS dim_company (
    company_key         BIGINT NOT NULL,                       -- Removed AUTO_INCREMENT
...
-- ========================================
-- 2. DIMENSION: Reporting Periods (FIXED)
-- ========================================
CREATE TABLE IF NOT EXISTS dim_period (
    period_key          BIGINT NOT NULL,                       -- Removed AUTO_INCREMENT
...
-- ========================================
-- 3. FACT: Income Statement (FIXED - DUPLICATE KEY)
-- ========================================
...
-- ========================================
-- 4. FACT: Balance Sheet (FIXED - DUPLICATE KEY)
-- ========================================
...
-- ========================================
-- 5. FACT: Cash Flow (FIXED - DUPLICATE KEY)
-- ========================================
...
-- ========================================
-- 6. FACT: Daily Market Data (FIXED - DUPLICATE KEY)
-- ========================================
...
-- ========================================
-- 6.1 FACT: Risk Metrics (FIXED - DUPLICATE KEY)
-- ========================================
...
-- ========================================
-- 7. DIMENSION: Macro Indicators (FIXED)
-- ========================================
CREATE TABLE IF NOT EXISTS dim_macro_indicator (
    indicator_key       BIGINT NOT NULL,                       -- Removed AUTO_INCREMENT
...
-- ========================================
-- 8. FACT: Macro Time Series (FIXED - DUPLICATE KEY)
-- ========================================
...
-- ========================================
-- 9. FACT: Bond Data (FIXED)
-- ========================================
CREATE TABLE IF NOT EXISTS fact_bond_data (
    bond_key            BIGINT NOT NULL,                       -- Removed AUTO_INCREMENT
    company_key         INT NOT NULL,
...
-- ========================================
-- 10. FACT: Forecast (FIXED - DUPLICATE KEY)
-- ========================================
...
-- ========================================
-- 12. SECTOR BENCHMARKS (FIXED - AGGREGATE KEY)
-- ========================================
...
-- ========================================
-- 13. MASTER ANALYSIS MART (FIXED - DUPLICATE KEY)
-- ========================================
...
CREATE TABLE IF NOT EXISTS audit_log (
    log_id              BIGINT NOT NULL,                       -- Removed AUTO_INCREMENT
    user_id             VARCHAR(100),
    action              VARCHAR(20),
...
-- ========================================
-- MATERIALIZED VIEWS (FIXED with DISTRIBUTED BY)
-- ========================================
